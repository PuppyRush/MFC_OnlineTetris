...
void CMyView::DrawImage(CDC *pDC)
{
	...
	if(!pDoc->m_isStart && !pDoc->m_end)
	{
		for (const auto pair : pDoc->m_clientUserList)
		{
			...
			case 2:
				...
				pDC->TextOutW(SX_MAIN + MAIN_WIDTH + GAME_SPACE + SUB_WIDTH / 2 - 10, SY_MAIN - 20, username);
				break;
			...
			case 5:
				...
				pDC->TextOutW(SX_MAIN + MAIN_WIDTH + GAME_SPACE + SUB_WIDTH / 2 - 10, SY_MAIN + MAIN_HEIGHT - 20, username);
				break;
			}
		}
	}//before start 
	...
	if(pDoc->m_isStart || pDoc->m_end)
	{
		...
		if(pDoc->m_ghost)
		{
			for(int i = 0; i < FG_FIXEDNUM; i++)
			{
				const auto c = ME->GhostFG.FgInfo[i];
		...
		for (const auto pair : pDoc->m_clientUserList)
		{
			...
			case 2:
				pDC->TextOutW(SX_MAIN + MAIN_WIDTH + GAME_SPACE + SUB_WIDTH / 4, SY_MAIN - 20, username);
				break;
			case 3:
				pDC->TextOutW(SX_MAIN + MAIN_WIDTH + SUB_WIDTH + SUB_WIDTH / 4 + GAME_SPACE * 2, SY_MAIN - 20, username);
				break;
			case 4:
				pDC->TextOutW(SX_MAIN + MAIN_WIDTH + SUB_WIDTH * 2 + SUB_WIDTH / 4, SY_MAIN - 20, username);
				break;
			case 5:
				pDC->TextOutW(SX_MAIN + MAIN_WIDTH / 2 - 10 + MAIN_WIDTH + GAME_SPACE, SY_MAIN - 20 + MAIN_HEIGHT, username);
				break;
			case 6:
				pDC->TextOutW(SX_MAIN + MAIN_WIDTH / 2 - 10 + MAIN_WIDTH + SUB_WIDTH + GAME_SPACE * 2, SY_MAIN - 20 + MAIN_HEIGHT, username);
				break;
			case 7:
				pDC->TextOutW(SX_MAIN + MAIN_WIDTH / 2 - 10 + MAIN_WIDTH + SUB_WIDTH * 2 + GAME_SPACE * 3, SY_MAIN - 20 + MAIN_HEIGHT, username);
				break;
