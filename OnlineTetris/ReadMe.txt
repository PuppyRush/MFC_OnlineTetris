================================================================================
    MFC 라이브러리 : OnlineTetris 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 OnlineTetris 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 OnlineTetris 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

OnlineTetris.vcxproj
...
OnlineTetris.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CMyApp 응용 프로그램
    클래스를 선언합니다.

OnlineTetris.cpp
    응용 프로그램 클래스 CMyApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\OnlineTetris.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다. 이 아이콘은
    주 리소스 파일인 OnlineTetris.rc에 의해 포함됩니다.

res\OnlineTetris.rc2
...
MyDoc.h, MyDoc.cpp - 문서
    이 파일에는 CMyDoc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CMyDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

MyView.h, MyView.cpp - 문서 뷰
    이 파일에는 CMyView 클래스가 들어 있습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 OnlineTetris.pch와
